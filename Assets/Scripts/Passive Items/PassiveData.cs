...
/// a single passive item, which is what we would have had to do if we continued using PassiveItemScriptableObject.
/// </summary>
[CreateAssetMenu(fileName = "Passive Data", menuName = "Scriptable Objects/Passive Data")]
