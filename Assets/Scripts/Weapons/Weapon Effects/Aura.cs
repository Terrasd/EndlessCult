...
/// It is used to give the functionality of Garlic, and it can also be used to spawn Holy Water
/// effects as well.
/// </summary>
public class Aura : WeaponEffect
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.TryGetComponent(out EnemyStats es))
        {
            ...
            {
                // Always starts with in interval 0, so that
                // it will get damaged in the next Update() tick.
