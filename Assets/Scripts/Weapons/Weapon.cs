...
/// ScriptableObjects to manage and run the behaviours of all weapon in the game. 
/// </summary>
public abstract class Weapon : Item
{
    ...
    public override bool DoLevelUp()
    {
        ...
        // Otherwise, add stats of the next level to out weapon
    ...
    // Performs an attack with the weapon. Returns true if the attack was succesful.
    ...
    public virtual bool ActivateCooldown(bool strict = false)
    {
        ...
        // Limit the max cooldown to the actual cooldown, so we cannot increase
